...
<div style="flex: 1 0 auto; height: 20px; width:300px; padding-bottom:2rem; color:#82BFAE">  A  </div> 
{% for tag in sortedPosts %}
    ...
    {% if old_name != null %}
        ...
        {% if old != new  %}
            <div style="padding-bottom:1.5rem; flex: 1 0 auto; height: 20px; width:330px; color: #82BFAE"> {{ new }} </div>
        {% endif %}
    {% endif %}

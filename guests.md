...
{% for tag in sortedPosts %}
    ...
    {% if old_name != null %}
        ...
        {% endif %}
    {% endif %}
    <div style="padding-bottom:1.5rem;flex: 1 0 auto; font-size: 0.75rem; height: 20px; width:330px; color: #B2B2B2"> <a  style="color: #B2B2B2" href='{{site.baseurl}}/tag/{{tag_name | slugify: "ascii"}}'  class="tag-head">{{ tag_name }} </a></div>
